...
const Timer5 = () => {
  ...
  return (
    // min-h-screen h-max md:h-screen
    <div className="flex flex-col md:flex-row justify-center items-center bg-gradient-to-l sm:bg-gradient-to-t from-[#88adf1] to-[#374b9c]">
