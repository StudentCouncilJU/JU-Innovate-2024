...
const Header = ({ onRegisterClick }) => { // Accept the onRegisterClick prop
  return (
      <>
          <header>
                      ...
                      <div className="relative w-[500px] max-w-screen-md lg:mt-0 -mt-14" style={{ fontFamily: "Customfont" }}>
                          ...
                          <div className='relative z-40'>
                              <div className='flex justify-center lg:mt-15 mt-10 gap-10 text-center custom-md:mt-10'>
                                  ...
                                  <div 
                                      className='button-85 rounded-3xl p-2 text-3xl text-bold hover:scale-105 hover:shadow hover:shadow-white' 
                                      style={{ fontFamily: "Customfont" }}
                                      onClick={onRegisterClick} // Attach the onClick handler
                                  >
                                      Register
                                  </div>
                              </div>
                          ...
                          <div className='flex justify-center gap-10 text-center mb-10 lg:mt-0 -mt-5'></div>
                      </div>
                  </div>
              </div>
          </header>
